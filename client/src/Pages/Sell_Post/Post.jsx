...
const Post = () => {
    ...
    const subcategories = {
        Cars: ['Cars'],
        Bike: ['Bikes'],
        'Electronics & Appliances': ['MobilPhones', 'Computers & Laptops'],
    };
    ...
    return (
        <div>
            ...
            <div className="w-[852px] h-180 mx-auto border">
                ...
                <div className="flex">
                    <div className="h-90 w-[425.5px] flex justify-start border-t border-r border-b border-l-0 overflow-y-auto">
                        <ul className="w-[100%]">
                        ...
                        {selectedCategory && (
                            <ul className="w-[100%]">
                                {subcategories[selectedCategory].map((subcategory, index) => (
                                    <li
                                        key={index}
                                        className="border-b border-t border-l flex items-center text-[#8d9094] p-[10px] hover:bg-gray-100"
