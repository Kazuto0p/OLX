...
const SellLaptop = () => {
  ...
  const laptopBrands = [
    'Apple', 'Samsung', 'Lenovo', 'Google', 'Dell', 'HP',
    'Asus', 'MSI', 'ThinkPad', 'Acer', 'Toshiba', 'LG',
  ];
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen flex justify-center">
      <div className="w-full max-w-md relative">
        ...
        <h1 className="text-lg font-bold uppercase mb-4 text-center">Sell Your Laptop</h1>
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="mb-4">
            ...
            <div className="p-2 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-#pragma once
1">Ad Title *</label>
                <input
                  type="text"
                  name="title"
